  ...
  return (
    <Container className="container-2">
      ...
      <Form.Group className="mb-3" controlId="formRecipeName">
          ...
          <Form.Control type="text" placeholder="Enter recipe name" value={name} onChange={handleNameChange} />
        </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formRecipeIngredients">
          ...
          {ingredients.map((ingredient, index) => (
            <div key={index}>
              <Form.Control type="text" placeholder="Enter ingredient" value={ingredient} onChange={(event) => handleIngredientChange(event, index)} />
              <Button variant="danger" onClick={(event) => handleRemoveIngredient(event, index)}>Remove</Button>
            </div>
          ))}
        ...
        <Form.Group className="mb-3" controlId="formRecipeSteps">
          ...
          {steps.map((step, index) => (
            <div key={index}>
              <Form.Control type="text" placeholder="Enter step" value={step} onChange={(event) => handleStepChange(event, index)} />
              <Button variant="danger" onClick={(event) => handleRemoveStep(event, index)}>Remove</Button>
            </div>
          ))}
        ...
        <Form.Group className="mb-3" controlId="formRecipeImages">
          ...
          <Form.Control type="text" placeholder="Enter image URL" value={images} onChange={handleImagesChange} />
        </Form.Group>
      ...
      <Container>
        <Row className="profileRow">
          ...
          <img src={images} className="rounded-circle img-thumbnail img-responsive profileImg" alt=""></img>          
